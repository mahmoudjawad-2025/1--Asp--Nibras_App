        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArabicAuthor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ArabicIntroduction = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnglishTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnglishAuthor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnglishIntroduction = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    createAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThikrCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HadithChapters_HadithBooks_HadithBookId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalNumber = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThikrCategoryId = table.Column<int>(type: "int", nullable: false),
                    createAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThikrItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ThikrItems_ThikrCategories_ThikrCategoryId",
                        column: x => x.ThikrCategoryId,
                        principalTable: "ThikrCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdInBook = table.Column<int>(type: "int", nullable: false),
                    ArabicText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NormalizedText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnglishNarrator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hadiths_HadithBooks_HadithBookId",
                        column: x => x.HadithBookId,
                        principalTable: "HadithBooks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Hadiths_HadithChapters_HadithChapterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizes_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ayahs_SurahNumber_NumberInSurah",
                table: "Ayahs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HadithChapters_HadithBookId",
                table: "HadithChapters",
                column: "HadithBookId");

            migrationBuilder.CreateIndex(
                name: "IX_Hadiths_HadithBookId",
                table: "Hadiths",
                column: "HadithBookId");

            migrationBuilder.CreateIndex(
                name: "IX_Hadiths_HadithChapterId",
                table: "Hadiths",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThikrItems_ThikrCategoryId",
                table: "ThikrItems",
                column: "ThikrCategoryId");
